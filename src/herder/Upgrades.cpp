...
void
save(Archive& ar, fotono::Upgrades::UpgradeParameters const& p)
{
    ar(make_nvp("time", fotono::VirtualClock::to_time_t(p.mUpgradeTime)));
...
template <class Archive>
void
load(Archive& ar, fotono::Upgrades::UpgradeParameters& o)
{
    time_t t;
    ar(make_nvp("time", t));
    o.mUpgradeTime = fotono::VirtualClock::from_time_t(t);
