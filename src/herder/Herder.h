 ...
 *
 * Drives the FCP consensus protocol, is responsible for collecting Txs and
...
class Herder
{
  public:
    ...
    // Maximum timeout for FCP consensus.
    ...
    virtual void peerDoesntHave(fotono::MessageType type,
    ...
    // lookup a nodeID in config and in FCP messages
