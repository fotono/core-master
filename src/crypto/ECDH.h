...
// overlay/PeerAuth.h), not the transaction-signing or FCP-message-signing
...
namespace std
{
template <> struct hash<fotono::Curve25519Public>
{
    size_t operator()(fotono::Curve25519Public const& x) const noexcept;
};
}
