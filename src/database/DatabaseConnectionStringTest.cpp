          ...
          "[db][dbconnectionstring]")
{
    ...
    {
        REQUIRE(removePasswordFromConnectionString(
                    R"(postgresql://password=abc dbname=fotono)") ==
                R"(postgresql://password=******** dbname=fotono)");
    }

    SECTION("password is removed if second")
    {
        REQUIRE(removePasswordFromConnectionString(
                    R"(postgresql://dbname=fotono password=dbname)") ==
                R"(postgresql://dbname=fotono password=********)");
    }
    ...
    SECTION("quoted password is removed")
    {
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname=fotono password='quoted password')") ==
            R"(postgresql://dbname=fotono password=********)");
    }
    ...
    SECTION("parameters after password remain unchanged")
    {
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname=fotono password='quoted \\ password' performance='as fast as possible')") ==
            R"(postgresql://dbname=fotono password=******** performance='as fast as possible')");
    }
    ...
    SECTION("dbname can be quored")
    {
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname='fotono with spaces' password='quoted \\ password' performance='as fast as possible')") ==
            R"(postgresql://dbname='fotono with spaces' password=******** performance='as fast as possible')");
    }
