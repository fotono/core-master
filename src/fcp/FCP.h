...
class FCP
{
  ...
  public:
    FCP(SCPDriver& driver, NodeID const& nodeID, bool isValidator,
    ...
    // this is the main entry point of the FCP library
    ...
    // Helpers for monitoring and reporting the internal memory-usage of the FCP
