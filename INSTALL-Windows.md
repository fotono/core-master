...
Note that you can (and should) install the Windows version of postgres even when running fotono-core from within WSL.


# Basic Installation

- `git clone PATH_TO_fotono_CORE`
- `git submodule init`
- `git submodule update`
- Open the solution `Builds\VisualStudio\fotono-core.sln`
