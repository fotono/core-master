...
class Config : public std::enable_shared_from_this<Config>
{
  ...
  public:
    ...
    // The default way fotono-core starts is to load the state from disk and
    // catch
    // up to the network before starting FCP.
    // If you need different behavior you need to use --newdb or --force-fcp
    // which sets the following flags:

    // FCP will start running immediately using the current local state to
    ...
    //  set here fotono-core won't run.
    ...
    fotono::SCPQuorumSet QUORUM_SET;
