...
{
size_t
hash<fotono::PublicKey>::operator()(fotono::PublicKey const& k) const noexcept
{
    assert(k.type() == fotono::PUBLIC_KEY_TYPE_ED25519);

    return std::hash<fotono::uint256>()(k.ed25519());
}
}
