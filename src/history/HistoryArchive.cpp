...
{
    return std::string("fotono-history.json");
}
...
HistoryArchiveState::HistoryArchiveState() : server(fotono_CORE_VERSION)
{
    uint256 u;
...
HistoryArchiveState::HistoryArchiveState(uint32_t ledgerSeq,
    ...
    : server(fotono_CORE_VERSION), currentLedger(ledgerSeq)
{
