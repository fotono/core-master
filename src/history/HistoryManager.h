 ...
 * stored at .well-known/fotono-history.json as a JSON file.
 *
 ...
 *
 * While the _most recent_ checkpoint is in .well-known/fotono-history.json,
 ...
 * LedgerManager (::mSyncingLedgers) and extended as FCP hears of new closes,
...
class HistoryManager
{
  public:
    ...
    // Infer a quorum set by reading FCP messages in history archives.
