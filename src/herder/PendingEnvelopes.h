...
/*
FCP messages that you have received but are waiting to get the info of
before feeding into FCP
*/
...
struct SlotEnvelopes
{
    ...
    // list of ready envelopes that haven't been sent to FCP yet
...
class PendingEnvelopes
{
    ...
    // discards all FCP envelopes thats use QSet with given hash,
