...
/* fotonoValue is the value used by FCP to reach consensus on a given ledger
*/
struct fotonoValue
{
...
struct LedgerHeader
{
    ...
    fotonoValue scpValue;   // what consensus agreed to
...
/* Ledger upgrades
note that the `upgrades` field from fotonoValue is normalized such that
...
// Transaction sets are the unit used by FCP to decide on transitions
// between ledgers
...
// FCP history file is an array of these
