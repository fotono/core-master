...
assetToString(const Asset& asset)
{
    ...
    switch (asset.type())
    {
    case fotono::ASSET_TYPE_NATIVE:
        r = std::string{"XLM"};
        break;
    case fotono::ASSET_TYPE_CREDIT_ALPHANUM4:
        assetCodeToStr(asset.alphaNum4().assetCode, r);
        break;
    case fotono::ASSET_TYPE_CREDIT_ALPHANUM12:
...
TEST_CASE("pathpayment", "[tx][pathpayment]")
{
    ...
    {
        auto market = TestMarket{*app};
        // see https://github.com/fotono/fotono-core/pull/1239
        auto minimumAccount =
