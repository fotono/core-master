...
{
std::string
StringMaker<fotono::OfferState>::convert(fotono::OfferState const& os)
{
    return fmt::format(
        ...
        os.type == fotono::OfferType::PASSIVE ? "passive" : "active");
}

std::string
StringMaker<fotono::CatchupRange>::convert(fotono::CatchupRange const& cr)
{
...
std::string
StringMaker<fotono::historytestutils::CatchupPerformedWork>::convert(
    fotono::historytestutils::CatchupPerformedWork const& cm)
{
    return fmt::format("{}, {}, {}, {}, {}, {}, {}, {}",
