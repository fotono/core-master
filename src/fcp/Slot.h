...
/**
 * The Slot object is in charge of maintaining the state of the FCP protocol
...
class Slot : public std::enable_shared_from_this<Slot>
{
  ...
  public:
    ...
    FCP::EnvelopeState processEnvelope(SCPEnvelope const& envelope, bool self);
    ...
    FCP::TriBool isNodeInQuorum(NodeID const& node);
