...
class SCPDriver
{
  public:
    ...
    // Users of the FCP library should inherit from SCPDriver and implement the
    // virtual methods which are called by the FCP implementation to
    // abstract the transport layer used from the implementation of the FCP
    // protocol.

    // Delegates the emission of an SCPEnvelope to the user of FCP. Envelopes
    ...
    // the following methods are used for monitoring of the FCP subsystem
