             ...
             public NonMovableOrCopyable
{
  ...
  protected:
    ...
    void recvMessage(fotonoMessage const& msg);
    void recvMessage(AuthenticatedMessage const& msg);
    void recvMessage(xdr::msg_ptr const& xdrBytes);

    virtual void recvError(fotonoMessage const& msg);
    // returns false if we should drop this peer
    void noteHandshakeSuccessInPeerRecord();
    void recvAuth(fotonoMessage const& msg);
    void recvDontHave(fotonoMessage const& msg);
    void recvGetPeers(fotonoMessage const& msg);
    void recvHello(Hello const& elo);
    void recvPeers(fotonoMessage const& msg);

    void recvGetTxSet(fotonoMessage const& msg);
    void recvTxSet(fotonoMessage const& msg);
    void recvTransaction(fotonoMessage const& msg);
    void recvGetSCPQuorumSet(fotonoMessage const& msg);
    void recvSCPQuorumSet(fotonoMessage const& msg);
    void recvSCPMessage(fotonoMessage const& msg);
    void recvGetSCPState(fotonoMessage const& msg);
  ...
  public:
    ...
    void sendMessage(fotonoMessage const& msg);
