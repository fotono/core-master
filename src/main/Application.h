...
/*
 * State of a single instance of the fotono-core application.
 *
...
class Application
{
  public:
    ...
    enum State
    {
        // Loading state from database, not yet active. FCP is inhibited.
        APP_BOOTING_STATE,

        // Out of sync with FCP peers
        APP_ACQUIRING_CONSENSUS_STATE,

        // Connected to other FCP peers
        ...
        // In sync with FCP peers, applying transactions. FCP is active,
        APP_SYNCED_STATE,
    ...
    // either restart or begin reacquiring FCP consensus (as instructed by
    // Config).
