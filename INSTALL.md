...
==================
These are intructions for building fotono-core from source. For a potentially quicker set up we also have fotono-core in a docker container: https://github.com/fotono/docker-fotono-core-horizon
...
- `git clone https://github.com/fotono/fotono-core.git`
- `cd fotono-core`
- `git submodule init`
