...
class LedgerManager
{
  public:
    ...
    // Called by Herder to inform LedgerManager that a FCP has agreed on a new
    ...
    // LedgerManager detects it is desynchronized from FCP's consensus ledger.
    ...
    // local buffer in which LedgerManager accumulates FCP consensus results
    // during catchup
    //
    ...
    // then we have error in code and fotono-core is aborted.
