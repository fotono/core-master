 ...
 * `fotonoMessage`, in the file src/xdr/fotono-overlay.x
 *
 ...
 *
 * The `fotonoMessage` union contains 3 logically distinct kinds of message:
 *
...
class OverlayManager
{
  public:
    ...
    // Herder.
    virtual void broadcastMessage(fotonoMessage const& msg,
                                  bool force = false) = 0;
    ...
    virtual void recvFloodedMsg(fotonoMessage const& msg,
                                Peer::pointer peer) = 0;
